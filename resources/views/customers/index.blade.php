...
<div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    ...
    <div class="flex gap-2 flex-wrap">
        ...
        <a href="{{ route('customers.export') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded inline-flex items-center">
            <i class="fas fa-file-excel mr-2"></i>Export Excel
        </a>
        <a href="{{ route('customers.pdf') }}" target="_blank" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded inline-flex items-center">
