...
<div class="mb-6">
    <div class="flex flex-col lg:flex-row gap-3 items-stretch lg:items-center">
        <form action="{{ route('suppliers.index') }}" method="GET" class="flex gap-2 flex-1 lg:max-w-md">
        ...
        <a href="{{ route('suppliers.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded inline-flex items-center">
        ...
        <a href="{{ route('suppliers.export') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded inline-flex items-center">
            <i class="fas fa-file-excel mr-2"></i>Export Excel
        </a>
        <a href="{{ route('suppliers.pdf') }}" target="_blank" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded inline-flex items-center">
